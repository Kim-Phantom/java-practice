...
public class systemMain {
    ...
    // 문자열 내에 역슬래시(\) [앤터키 위에] 은 특정 기능을 사용할 수 있음
    // \n 줄바꿈
    ...
    // 포멧을 표현할때는 %를 씀
    // 여러개 가능 ("대상문자열",값,값,....)
    System.out.printf("원주율은 %.2f", 3.141592);
    System.out.printf("%d명이 수업을 듣고있습니다.",24, "수업");
    ...
    System.out.println("에어컨 희망 온도를 입려해 주세요.");
    System.out.print(" >>>  ");
    int temper = Integer.parseInt(scan.nextLine());  // 밑에거랑 둘중하나 쓰기
//    int temper = scan.nextInt();
    System.out.printf("희망온도 %d 이군요.", temper);
    
    // 사용자의 취미를 입력받아 출력해 보세요
    // 취미는 어떤건가요?
    // >>> 
    // 취미가 [입력받은값] 이군요. 를 출력해 주세요
    System.out.println("취미가 무엇인가요?");
    System.out.print(" >>>    ");
    String hobby = scan.nextLine();
    System.out.printf("취미가 %s 군요", hobby);
    scan.close();

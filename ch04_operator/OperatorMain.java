...
public class OperatorMain {
   ...
   System.out.println("/n ===============산술 연산자===========/n");
   // +-*/%
   int numA = 10;
   int numB = 3;
   numA = numA + 1;
   System.out.println(numA);
   System.err.println("numA:%d num:%d, numA, numB");
   ...
   // (a) ? (b) : (c) a의 식이 true이면 b false이면 c 를 리턴
   ...
   //문제 1. 사용자의 나이를 입력받아 10대, 20대, 30대... 를 출력하고 10대 일 경우에는 입장 불가를 출력하시오
	Scanner scanner = new Scanner(System.in);
	System.out.println("=====================");
	System.out.println("나이를 입력해주세요 : ");
	int userNum = scanner.nextInt();
	String strNum = userNum + "";
	String output = (userNum >= 20) ? strNum.substring(0, 1) + "0대 입장가능" : "10대 입장불가!";
   ...
   // 를 출력하시오
	...
	String output2 = (len >= 8 && len < 15) ? "사용가능한 아이디 입니다." : "8~14 자리로 입력하세요";

...
public class ArrayMain {
	...
	public static void main(String[] args) {
	 ...
	 // 오공을 드래곤볼 오공으로 변경
	     ...
	     String [] students = {"팽수","길동","동익","길수"};
	     printArr(students);
	     String subjects = "자바, SQL, 화면구현, JSP";
	     //.split(문자열)
	     // 대상문자열을 문자열 기중으로 나누어 배열로 리턴
	     ...
	     printArr(subArr);
	     //매열의 복사(shallow copy 얇은 복사) 주소값 복사
	     ...
	     printArr(numArr);
	     //버블정렬
	     //이 알고리즘은 가장 큰값(or 작음값)을 마치
	     //거품 처럼 끝으로 밀어내는 방식으로 동작
	     
	     //배열의 처음부터 인접한 항복을 쌍으로 비교
